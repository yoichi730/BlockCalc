...
namespace WinFormCalcDB.Repositories
{
    public class DBRepository : IHistoryRepository
    {
        // todo: вынести в конфиг
        string connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;
                                    AttachDbFilename=C:\Users\Anton\Documents\Visual Studio 2015\Projects\BlockCalc_2\WinFormCalcDB\App_data\CalcDB.mdf;
